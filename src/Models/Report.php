...
class Report {
    ...
    public function getMonthlyRevenue(int $year): array {
        $sql = "SELECT 
                ...
                FROM Bookings 
                WHERE YEAR(BookingDate) = :year AND PaymentStatus = 'Đã thanh toán'
    ...
    public function getSummary(): array {
        $stmt = $this->db->query("SELECT SUM(TotalAmount) as total FROM Bookings WHERE PaymentStatus = 'Đã thanh toán'");
